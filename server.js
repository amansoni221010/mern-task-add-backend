...
const PORT= process.env.PORT || 8000; //line-2

const USERNAME=process.env.DB_USERNAME; //5
const PASSWORD=process.env.DB_PASSWORD; //6


const URL= process.env.MONGODB_URI || `mongodb+srv://${USERNAME}:${PASSWORD}@ecommerce-web.be47vux.mongodb.net/?retryWrites=true&w=majority`;


// Connection( USERNAME, PASSWORD); //line-3 //7
Connection( URL); //line-3 //7
